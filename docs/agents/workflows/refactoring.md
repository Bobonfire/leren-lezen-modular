...
Deze workflow is een gespecialiseerde route binnen Full Delivery. Gebruik
`full-delivery.md` voor refinement, PR-, documentatie-, acceptance- en
approvalgates.
...
* Bij timeout krijgt een agent eenmaal een verkorte completion-opdracht.
* Alleen wanneer essentieel bewijs ontbreekt volgt maximaal een gerichte
  herstart; daarna escaleert de Orchestrator zonder extra agentruns.
